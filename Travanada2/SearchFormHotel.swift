...
import SwiftyJSON
    ...
    class SearchFormHotel: UIViewController, CLLocationManagerDelegate {
...
//            self.view.insertSubview(backgroundImage, at: 0)
        ...
        @objc func didTapLabelDemo3(sender: UITapGestureRecognizer)
        {
            ...
            delegate4.dataPassing4(name4: self.currentAirport)
            ...
            if let path = Bundle.main.path(forResource: "airport", ofType: "txt") {
                do {
                    ...
                    for country in jsonResult {
                        let first = country["IATAcode"]! + ", " +  country["CountryCode"]!
        ...
        @IBAction func doneBtnTap(_ sender: Any) {
            delegate4.dataPassing4(name4: searchLocation.text!)

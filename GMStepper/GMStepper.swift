...
@IBDesignable public class GMStepper: UIControl {
    ...
    @objc @IBInspectable public var value: Int = 0 {
        didSet {
    ...
    private var formattedValue: String? {
        ...
        if isInteger && stepValue == 1 && items.count > 0 {
    ...
    @objc @IBInspectable public var minimumValue: Int = 0 {
        didSet {
            value = min(maximumValue, max(minimumValue, value))
        }
    }
    ...
    @objc @IBInspectable public var maximumValue: Int = 100 {
        didSet {
            value = min(maximumValue, max(minimumValue, value))
        }
    }
